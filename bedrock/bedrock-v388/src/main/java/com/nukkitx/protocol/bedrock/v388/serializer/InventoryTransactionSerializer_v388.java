...
public class InventoryTransactionSerializer_v388 implements PacketSerializer<InventoryTransactionPacket> {
    public static final InventoryTransactionSerializer_v388 INSTANCE = new InventoryTransactionSerializer_v388();
